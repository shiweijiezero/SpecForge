...
CHECKPOINT_PATH=${WORK_PATH}/checkpoints/calm_flow
...
torchrun --nnodes 1 --node_rank 0 --nproc_per_node 8 \
    ...
    --config_overrides "model_type=flow,latent_size=128,num_mlp_layers=4,patch_size=4,hidden_size=1024,intermediate_size=2752,num_hidden_layers=16,num_attention_heads=16,num_key_value_heads=16" \
