...
def _calculate_settings(n):
    ...
    # For large vocabularies (> 65536), use the actual vocab size as BLOCK_SIZE
    # to avoid multiple iterations. Triton supports block sizes up to several hundred thousand.
